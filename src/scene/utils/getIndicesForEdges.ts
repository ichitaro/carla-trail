// based on https://github.com/mrdoob/three.js/blob/master/src/geometries/EdgesGeometry.js
...
export default function getIndicesForEdges(
    ...
    for (let j = 0; j < 3; j++) {
      ...
      if (reverseHash in edgeData && edgeData[reverseHash]) {
        ...
        if (_normal.dot(edgeData[reverseHash].normal) <= thresholdDot) {
          ...
          indices.push([indexArr[j], indexArr[jNext]])
        }
